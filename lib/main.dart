...
import 'package:alarm_app_forecast/weather/weather_home/weather_home.dart';
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: Icon(color: Color.fromARGB(255, 233, 80, 9), Icons.home),
              label: "Home",
            ),
            BottomNavigationBarItem(
              icon: Icon(color: Color.fromARGB(255, 233, 80, 9), Icons.cloud),
              label: "Settings",
            ),
          ],
        ),
